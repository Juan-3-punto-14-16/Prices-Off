<div class="contenedor_agregar">
    ...
    <form class="formulario_productos" id="formulario_productos" action="/api/guardar" method="POST">
        <div class="centrar_contenido">
            <button class="btn_escanear" id="btn_escanear" type="button">Escanear Ticket</button>
            <input type="file" id="input_ticket" accept="image/*" capture="environment" style="display: none;">
